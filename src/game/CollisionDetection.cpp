...
bool CollisionDetection::check_collision(GameObject first, GameObject second) {
    ...
    size_t count1 = (sizeof(std::vector<vec2>) + (sizeof(vec2) * vertices1.size())) / sizeof(vec2);
    size_t count2 = (sizeof(std::vector<vec2>) + (sizeof(vec2) * vertices2.size())) / sizeof(vec2);
